...
public class PlaybackVideoFragment extends VideoSupportFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final MovieTile movie = (MovieTile) getActivity().getIntent().getParcelableExtra(DetailsActivity.MOVIE);
        ...
        mTransportControlGlue.setSubtitle(movie.getTileContentText());
        mTransportControlGlue.playWhenPrepared();

        playerAdapter.setDataSource(Uri.parse("http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4"));
    }
