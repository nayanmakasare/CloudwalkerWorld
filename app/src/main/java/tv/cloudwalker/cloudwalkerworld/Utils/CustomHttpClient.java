...
public class CustomHttpClient {
    ...
    static final String tvUserAgent = "";
            ...
            builder.addInterceptor(new Interceptor() {
                ...
                public Response intercept(Chain chain) throws IOException {
                    ...
                    Request request = original.newBuilder()
                            ...
                            .header("mboard", "TP.MT5510I.PB801")
                            .header("panel", "PT320AT01-1")
                            .header("model", "CWT32SHX2")
                            .header("cotaversion", "201801225_245959")
                            .header("fotaversion", "ebrujtunkiylfkburybk")
                            .header("lversion", "1.5.0-15-gdd28496-dirty")
